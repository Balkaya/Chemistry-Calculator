...
let atomsName = [
    hydrogen.name, helium.name, lithium.name, beryllium.name, boron.name, carbon.name, nitrogen.name, oxygen.name, fluorine.name, neon.name, sodium.name, magnesium.name, aluminum.name, silicon.name, phosphate.name, sulfur.name, chlorine.name, argon.name, potassium.name, calcium.name, scandium.name, titanium.name, vanadyum.name, chromium.name, mangenese.name, iron.name, cobalt.name, nickel.name, copper.name, zinc.name, gallium.name, germanium.name, arsenic.name, selenium.name, brom.name, krypton.name, rubidium.name, strontium.name, yttrium.name, zirconium.name, niobium.name, molybdenum.name, technetium.name, ruthenium.name, rhodium.name, palladium.name, silver.name, cadmium.name, indium.name, stannic.name, antimony.name, tellurium.name, iodine.name, xenon.name, cesium.name, barium.name, lanfan.name, cerium.name, praseodymium.name, neodymium.name, promethium.name, samarium.name, europium.name, gadolinium.name, terbium.name, dysprosium.name, holmium.name, erbium.name, thulium.name, ytterbium.name, lutetium.name, hafnium.name, tantalum.name, wolfram.name, rhenium.name, osmium.name, iridium.name, platinum.name, gold.name, mercury.name, thallium.name, bullet.name, bismuth.name, polonium.name, astatine.name, radon.name, francium.name, radium.name, actinium.name, thorium.name, protactinium.name, uranium.name, neptunium.name, plutonium.name, americium.name, curium.name, berkelium.name, californium.name, einsteinium.name, fermium.name, mendelevyum.name, nobelium.name, lawrentium.name, rutherfordium.name, dubnium.name, seaborgium.name, bohrium.name, hassium.name, meitnerium.name, darmstadtium.name, roentgenium.name, copernicium.name, nihonium.name, flerovium.name, moscovium.name, livermorium.name, tennesine.name, oganesson.name
]

let atomsShortName = [
    hydrogen.shortName, helium.shortName, lithium.shortName, beryllium.shortName, boron.shortName, carbon.shortName, nitrogen.shortName, oxygen.shortName, fluorine.shortName, neon.shortName, sodium.shortName, magnesium.shortName, aluminum.shortName, silicon.shortName, phosphate.shortName, sulfur.shortName, chlorine.shortName, argon.shortName, potassium.shortName, calcium.shortName, scandium.shortName, titanium.shortName, vanadyum.shortName, chromium.shortName, mangenese.shortName, iron.shortName, cobalt.shortName, nickel.shortName, copper.shortName, zinc.shortName, gallium.shortName, germanium.shortName, arsenic.shortName, selenium.shortName, brom.shortName, krypton.shortName, rubidium.shortName, strontium.shortName, yttrium.shortName, zirconium.shortName, niobium.shortName, molybdenum.shortName, technetium.shortName, ruthenium.shortName, rhodium.shortName, palladium.shortName, silver.shortName, cadmium.shortName, indium.shortName, stannic.shortName, antimony.shortName, tellurium.shortName, iodine.shortName, xenon.shortName, cesium.shortName, barium.shortName, lanfan.shortName, cerium.shortName, praseodymium.shortName, neodymium.shortName, promethium.shortName, samarium.shortName, europium.shortName, gadolinium.shortName, terbium.shortName, dysprosium.shortName, holmium.shortName, erbium.shortName, thulium.shortName, ytterbium.shortName, lutetium.shortName, hafnium.shortName, tantalum.shortName, wolfram.shortName, rhenium.shortName, osmium.shortName, iridium.shortName, platinum.shortName, gold.shortName, mercury.shortName, thallium.shortName, bullet.shortName, bismuth.shortName, polonium.shortName, astatine.shortName, radon.shortName, francium.shortName, radium.shortName, actinium.shortName, thorium.shortName, protactinium.shortName, uranium.shortName, neptunium.shortName, plutonium.shortName, americium.shortName, curium.shortName, berkelium.shortName, californium.shortName, einsteinium.shortName, fermium.shortName, mendelevyum.shortName, nobelium.shortName, lawrentium.shortName, rutherfordium.shortName, dubnium.shortName, seaborgium.shortName, bohrium.shortName, hassium.shortName, meitnerium.shortName, darmstadtium.shortName, roentgenium.shortName, copernicium.shortName, nihonium.shortName, flerovium.shortName, moscovium.shortName, livermorium.shortName, tennesine.shortName, oganesson.shortName
]
